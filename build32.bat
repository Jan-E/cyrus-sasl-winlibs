...
nmake /F NTMakefile NTDLL=yes STATIC=no SQL=SQLITE3 SQLITE_INCLUDES3=\php-sdk\win32build\include SQLITE_LIBPATH3=\php-sdk\win32build\lib LDAP=1 LDAP_INCLUDE=\php-sdk\win32build\include\openldap LDAP_LIB_BASE=\php-sdk\winlibs\openldap-2.4.47-noSASL\win32build.vc15noSASL\lib SASLDB=1 DBLIB=berkeley DB_LIB=\php-sdk\win32build\lib\libdb48s.lib DB_INCLUDE=\php-sdk\win32build\include OPENSSL_INCLUDE=\php-sdk\win32build\include OPENSSL_LIBPATH=\php-sdk\win32build\lib NTLM=1 SRP=0 OTP=1 install
